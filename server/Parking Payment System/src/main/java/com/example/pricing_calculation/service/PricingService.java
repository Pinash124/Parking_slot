...
public class PricingService {
    ...
    public PricingQuoteResponse estimate(
        ...
        PricingPolicy policy = findPolicy(vehicleTypeId, entryTime);
    ...
    @Transactional(readOnly = true)
    public List<PricingPolicy> activePolicies(Long vehicleTypeId, LocalDateTime atTime) {
        if (vehicleTypeId == null) {
            throw new BadRequestException("vehicleTypeId is required");
        }
    ...
    private PricingPolicy findPolicy(Long vehicleTypeId, LocalDateTime atTime) {
