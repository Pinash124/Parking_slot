...
public class TransactionHistoryResponse {
    ...
    private TransactionHistoryResponse(TransactionHistory transaction) {
        ...
        ParkingSession session = payment == null ? null : payment.getSession();
        ...
        ParkingSlot slot = session == null ? null : session.getSlot();
    ...
    private TransactionType deriveType(TransactionHistory transaction, Payment payment, ParkingSession session) {
    ...
    private Integer calculateDurationMinutes(ParkingSession session) {
    ...
    private String buildNote(Payment payment, ParkingSession session) {
        if (session == null) {
            return null;
        }
