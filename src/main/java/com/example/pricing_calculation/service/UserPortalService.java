...
public class UserPortalService {
    ...
    public UserPortalService(VehicleRepository vehicles,PaymentModuleVehicleTypeRepository vehicleTypes,
            ...
            AdditionalServiceRepository services,SessionServiceUsageRepository usages){this.vehicles=vehicles;this.vehicleTypes=vehicleTypes;this.sessions=sessions;this.pricing=pricing;this.services=services;this.usages=usages;}
