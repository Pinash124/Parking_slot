...
public class UserPortalController {
    ...
    @PostMapping("/monthly-passes/{id}/payment/online-qr") public MonthlyParkingPassDtos.MonthlyParkingPassPaymentInstructionResponse prepareMonthlyPassOnlinePayment(@RequestHeader("Authorization")String h,@PathVariable Long id,@RequestBody(required=false) MonthlyParkingPassDtos.MonthlyParkingPassPaymentPrepareRequest r){return portal.prepareMonthlyPassOnlinePayment(user(h),id,r);}
    @PostMapping("/monthly-passes/{id}/payment/cash-bill") public MonthlyParkingPassDtos.MonthlyParkingPassPaymentInstructionResponse prepareMonthlyPassCashBill(@RequestHeader("Authorization")String h,@PathVariable Long id){return portal.prepareMonthlyPassCashBill(user(h),id);}
