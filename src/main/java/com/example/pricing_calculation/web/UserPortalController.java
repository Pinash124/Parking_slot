...
public class UserPortalController {
    ...
    @PostMapping("/reservations") public ReservationResponse reserve(@RequestHeader("Authorization")String h,@RequestBody ReservationCreateRequest r){UserAccount u=user(h);return reservations.create(new ReservationCreateRequest(u.getId(),r.vehicleId(),r.zoneId(),r.slotId(),r.startTime(),r.endTime()));}
