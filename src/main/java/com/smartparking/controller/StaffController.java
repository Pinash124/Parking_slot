...
public class StaffController {
    ...
    public ResponseEntity<ParkingIncident> resolveIncident(
            @PathVariable Long id,
            @Nullable @RequestParam(required = false) Long staffId) {
        return ResponseEntity.ok(staffService.resolveIncident(id, staffId));
    }
}
